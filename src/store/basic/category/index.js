...
// ** Fetch Categorys
export const fetchCategory = createAsyncThunk('category/fetchData', async (params, thunkAPI) => {
  const header = {
...
export const addCategory = createAsyncThunk('category/addData', async (params, thunkAPI) => {
  const header = {
    'Content-Type': 'application/json',
    'Authorization': `Bearer ${window.localStorage.getItem(urls.access)}`
  }
...
export const editCategory = createAsyncThunk('category/editData', async (params, thunkAPI) => {
  const header = {
    'Content-Type': 'application/json',
    'Authorization': `Bearer ${window.localStorage.getItem(urls.access)}`
  }
...
export const deleteCategory = createAsyncThunk('category/deleteData', async (params, thunkAPI) => {
  const header = {
    'Content-Type': 'application/json',
    'Authorization': `Bearer ${window.localStorage.getItem(urls.access)}`
  }
